...
public class OrderExpiryTask {
     ...
     * CANCELLED olarak işaretler ve stokları geri yükler.
     */
    ...
    public void cancelExpiredOrders() {
        ...
        for (Order order : expiredOrders) {
            ...
            // Bloklanan stokları geri yükle
            try {
                orderService.revertStockForOrder(order.getId());
            } catch (Exception e) {
                log.error("Stok iadesi başarısız: orderId={}, hata={}", order.getId(), e.getMessage());
            }
            log.info("Süresi dolmuş sipariş iptal edildi ve stok iade edildi: orderId={}, orderDate={}",
