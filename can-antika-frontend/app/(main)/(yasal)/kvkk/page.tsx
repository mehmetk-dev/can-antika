        ...
        <article className="mx-auto max-w-4xl rounded-2xl border bg-card p-6 shadow-sm md:p-10">
          ...
          <section className="mt-8 space-y-5">
            ...
            <div className="space-y-2">
              ...
              <p className="leading-7">Toplama Yöntemi: İletişim formu, e-posta, telefon, WhatsApp</p>
            </div>
          ...
          <section className="mt-8 space-y-3">
            ...
            <p className="leading-7">
              Kullandığımız bazı e-posta, bulut bilişim, güvenlik, analitik veya barındırma hizmetlerinin (Vercel, Google vb.) yurt dışında bulunması halinde kişisel
