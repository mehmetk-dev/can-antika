...
export default function BlogPage() {
    ...
    const savePost = async () => {
        ...
        if (!postForm.categoryId || postForm.categoryId <= 0) { toast.error("Kategori seçimi zorunlu"); return }
        try {
