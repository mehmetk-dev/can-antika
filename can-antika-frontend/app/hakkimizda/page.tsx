    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        {false && <section className="hidden">
          ...
          <div className="absolute bottom-8 left-8 right-8 top-8 pointer-events-none border border-accent/20" />
          <div className="absolute bottom-12 left-12 right-12 top-12 pointer-events-none border border-accent/10" />
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <span className="mb-4 inline-block text-lg uppercase tracking-widest text-accent font-serif">
              Est. 1990
            </span>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                >
                  <div className="absolute left-3 top-3 h-4 w-4 border-l-2 border-t-2 border-accent/30 opacity-0 transition-opacity group-hover:opacity-100" />
                  <div className="absolute right-3 top-3 h-4 w-4 border-r-2 border-t-2 border-accent/30 opacity-0 transition-opacity group-hover:opacity-100" />
                  <div className="absolute bottom-3 left-3 h-4 w-4 border-b-2 border-l-2 border-accent/30 opacity-0 transition-opacity group-hover:opacity-100" />
                  <div className="absolute bottom-3 right-3 h-4 w-4 border-b-2 border-r-2 border-accent/30 opacity-0 transition-opacity group-hover:opacity-100" />
        ...
        <section className="relative overflow-hidden bg-primary py-24">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute left-0 top-0 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full border border-accent" />
            <div className="absolute bottom-0 right-0 h-[500px] w-[500px] translate-x-1/3 translate-y-1/3 rounded-full border border-accent" />
          </div>
