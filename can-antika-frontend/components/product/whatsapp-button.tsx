...
export function WhatsAppButton({ product, className = "" }: WhatsAppButtonProps) {
    return (
        <a
            ...
            className={`inline-flex min-h-11 w-full max-w-full items-center justify-center gap-2 whitespace-normal break-words rounded-md bg-[#25D366] px-3 py-2 text-center text-sm font-medium text-white shadow-sm transition-colors hover:bg-[#1da851] ${className}`}
        >
