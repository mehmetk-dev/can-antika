...
export function WhatsAppButton({ product, className = "" }: WhatsAppButtonProps) {
    return (
        <a
            ...
            className={`inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-md bg-[#25D366] px-4 text-sm font-medium text-white shadow-sm transition-colors hover:bg-[#1da851] ${className}`}
        >
