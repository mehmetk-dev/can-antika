...
export const ProductCard = memo(function ProductCard({ product, isPriority = false }: ProductCardProps) {
  ...
  return (
    <div className="group relative flex h-full min-w-0 flex-col border border-border/80 bg-card p-2 hover:border-primary/30 hover:shadow-[0_12px_28px_rgba(123,64,25,0.05)] rounded-xl transition-all duration-300">
