...
test("address form uses Turkiye API backed province district neighborhood selects", () => {
  ...
  assert.match(addressPage, /provinceSearch/)
  assert.match(addressPage, /districtSearch/)
  assert.match(addressPage, /neighborhoodSearch/)
  assert.match(addressPage, /normalizeAddressSearch/)
  assert.match(addressPage, /Mahalle veya köy ara/)
